  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Configure and launch your grid trading bot</p>
      </div>
      ...
      {/* Trailing Profit — Plan Comparison + Add-on */}
      <Card>
        <CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          {/* Trailing config — only shown if user has access */}

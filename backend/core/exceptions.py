...
class ExchangeError(UTOSException):
    ...
    def __init__(self, message: str, exchange_name: str, error_code: Optional[str] = None, details: Optional[dict] = None):
...
class RiskLimitExceeded(UTOSException):
    ...
    def __init__(self, message: str, limit_type: str, current_value: Optional[float] = None, limit_value: Optional[float] = None):
        super().__init__(message)
...
class InvalidQuantity(UTOSException):
    ...
    def __init__(self, message: str, quantity: Optional[float] = None, min_quantity: Optional[float] = None, max_quantity: Optional[float] = None):
        super().__init__(message)
...
class InvalidPrice(UTOSException):
    ...
    def __init__(self, message: str, price: Optional[float] = None, min_price: Optional[float] = None, max_price: Optional[float] = None):
        super().__init__(message)
        self.price = price

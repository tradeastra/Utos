...
class TestAddRemoveRule:
    ...
    def test_add_rule(self) -> None:
        ...
        rule_id = rules.add_rule(
            ...
            lambda d: True, "telegram", "order_filled",
        )
    ...
    def test_remove_rule(self) -> None:
        rules = AutomationRules()
        rule_id = rules.add_rule("test", "TEST", lambda d: True, "telegram", "order_filled")
...
class TestEvaluate:
    ...
    async def test_evaluate_wrong_event_type(self) -> None:
        rules = AutomationRules()
        rules.add_rule("test", "ORDER_FILLED", lambda d: True, "telegram", "order_filled")

...
class TestPortfolioManagerRegister:
    ...
    def test_register_invalid_side(self) -> None:
        ...
        with pytest.raises(ValidationError, match="side"):
            pm.register_position("inst-1", "acc-1", "binance", "BTCUSDT", "sideways", Decimal("100"), Decimal("2"))

    def test_register_invalid_price(self) -> None:
        pm = PortfolioManager()
        with pytest.raises(ValidationError, match="entry_price"):
            pm.register_position("inst-1", "acc-1", "binance", "BTCUSDT", "long", Decimal("0"), Decimal("2"))

    def test_register_invalid_quantity(self) -> None:
        pm = PortfolioManager()
        with pytest.raises(ValidationError, match="quantity"):
            pm.register_position("inst-1", "acc-1", "binance", "BTCUSDT", "long", Decimal("100"), Decimal("0"))
...
class TestPortfolioManagerUpdate:
    ...
    def test_update_closed_raises(self) -> None:
        ...
        pm2.register_position("inst-2", "acc-1", "binance", "BTCUSDT", "long", Decimal("100"), Decimal("2"))
...
class TestPortfolioManagerQuery:
    ...
    def test_get_positions_filter_by_exchange(self) -> None:
        pm = PortfolioManager()
        pm.register_position("inst-1", "acc-1", "binance", "BTCUSDT", "long", Decimal("100"), Decimal("2"))
        pm.register_position("inst-2", "acc-1", "bybit", "BTCUSDT", "long", Decimal("100"), Decimal("2"))
